...
use crate::endpoint::{error_response, service_unavailable_response, GraphQlEndpoint};
...
impl TransportApi for TransportApiImpl {
    ...
    async fn graphql_subscribe(
        ...
        // The start gate prevents a short stream from completing before its
        // abort handle has been inserted into the registry.
